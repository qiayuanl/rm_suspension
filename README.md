...
2. 下载这个[rm_description](https://github.com/QiayuanLiao/rm_suspension/releases/download/1.0/rm_description.tar.xz) 这个包，并将其放到工作区。 注：rm_description由Solidworks生成，包含描述机器人网格、坐标系和惯性的URDF文件。 但我们只把它用于可视化！！！你可以在没有rm_description的情况下运行程序，整个计算过程仍将正常工作。
