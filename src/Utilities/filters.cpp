...
template
class butterworth_filter<double>;
template
class butterworth_filter<float>;
...
template
class digital_lp_filter<double>;
template
class digital_lp_filter<float>;
...
template
class deriv_lp_filter<double>;
template
class deriv_lp_filter<float>;
...
template
class ff01_filter<float>;
template
class ff01_filter<double>;
...
template
class ff02_filter<float>;
template
class ff02_filter<double>;
